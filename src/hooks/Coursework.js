        ...
        <div className="col">
          <div className="card mb-4">
            <div className="card-body">
              <div className="card-title"><div className="h2-responsive">Coursework</div></div>
              ...
              <div className="h5-responsive mb-4">
                ...
                I read four research papers relating to the BERT natural language processing model and wrote my own abstracts 
              ...
              I provide a detailed description of how neural networks work in machine learning. This description assumes appropriate
              ...
              by modeling the puzzle as a Constraint Satisfaction Problem. Constraint Satisfaction Problems have viable solution algorithms developed, so
